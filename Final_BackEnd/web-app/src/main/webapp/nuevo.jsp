                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page"
                            href="<%=request.getContextPath()%>/ListadoPersonasController">Listado</a>
                    </li>
                </ul>
        ...
        <div class="row">
            <div class="col-12">
                <section>
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/AltaPersonaController">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Edad
                            </label>
